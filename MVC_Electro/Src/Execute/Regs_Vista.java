...
public class Regs_Vista extends JDialog
{
	...
	{
		if(title.equals("Modificar")) txtGroup[0].setEditable(false);
		...
		if(tabla.equals("Empleados")) chbMarried.setSelected(Boolean.parseBoolean("" + values[length]));
	}
	...
	private void initComponents()
	{
		...
		{
			length--;
			chbMarried = new JCheckBox(labels[length]);
			chbMarried.setCursor(Root.cur);
		}
		
		txtGroup = new JTextField[length];
		...
		if(tabla.equals("Empleados")) pnlTxt.add(chbMarried);
